...
namespace Element.Reveal.TrueTask
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            var rootFrame = Window.Current.Content as WinAppLibrary.UI.TrueTaskMasterPage;
            ...
            if (rootFrame == null)
            {
                ...
                rootFrame = new WinAppLibrary.UI.TrueTaskMasterPage();
                ...
                rootFrame.OptionSaved += (s, e) =>
                {
                    ...
                    Login.UserAccount.CurDisciplineCode = rootFrame.CurDisciplineCode;
