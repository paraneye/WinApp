...
namespace Element.Reveal.TrueTask.Lib
{
    public sealed class TimesheetTotalConverter : IValueConverter
    {
                          ...
                          object parameter, string culture)
        {
            try
            {
                var timsheet = (DataLibrary.TimesheetDTO)value;
                if (timsheet != null)
    ...
    public sealed class ContentPath
    {
        ...
        public const string DefaultDrawing = "Assets/Default.png";
    ...
    public sealed class MainMenuList
    {
        ...
        public const string BuildSchedule = "BuildSchedule";
        public const string BuildIWP = "BuildIWP";
        public const string BuildSIWP = "BuildSIWP";
        public const string BuildHydro = "BuildHydro";
        public const string ManageSchedule = "ManageSchedule";
        public const string IWPViewer = "IWPViewer";
        public const string DrawingViewer = "DrawingViewer";
        public const string SIWPViewer = "SIWPViewer";
        public const string AssembleIWP = "AssembleIWP";
        public const string TurnoverbinderViewer = "TurnoverbinderViewer";

        public const string AssembleSIWP = "AssembleSIWP";
        public const string AssembleHydroPackage = "AssembleHydroPackage";

        public const string InspectionTestRecord = "InspectionTestRecord";
        public const string ITRReport = "ITRReport";

        public const string WalkDown = "WalkDown";
        public const string AssignmentPuch = "AssignmentPuch";
        public const string PunchListCard = "PunchListCard";
        public const string PunchSummary = "PunchSummary";
        public const string TurnoverSystem = "TurnoverSystem";
        public const string BuildCSU = "BuildCSU";
        public const string AssembleCSU = "AssembleCSU";
        public const string HydroViewer = "HydroViewer";
        public const string CSUViewer = "CSUViewer";

        public const string IWPSignoff = "IWPSignoff";

        public const string SignOffStatus = "SignOffStatus";
    }

    public sealed class SubMenuList
    {
        public const string IWPSchedule = "IWPSchedule";
        public const string ProjectSchedule = "ProjectSchedule";
        public const string ManpowerLoading = "ManpowerLoading";
    }
    ...
    public sealed class TaskTypeName
    {
    ...
    public sealed class ITRList
    {
        ...
        public const string CableTrayInspection = "ITR-5.6.4.1";
        public const string LightingDeviceInstallation = "ITR-5.6.3.1";
        public const string LightingDeviceCircuit = "ITR-5.6.3.2";
        public const string PowerCableReelReceiving = "ITR-5.6.7.1";
        public const string ControlCableReelReciving = "ITR-5.6.7.2";
        public const string InstrumentCableReelReceiving = "ITR-5.6.7.3";
        public const string PowerCableInspection = "ITR-5.6.7.4";
        public const string ControlCableInspection = "ITR-5.6.7.5";
        public const string InstrumentCableInspection = "ITR-5.6.7.6";
        public const string MIReceiving = "ITR-5.6.6.1";
        public const string SRPLReceiving = "ITR-5.6.6.2";
        public const string MIInspection = "ITR-5.6.6.3";
        public const string SRPLInspection = "ITR-5.6.6.4";

        public const string INSTRUMENTATIONReceiving = "ITR-5.7.0.1";
        public const string INSTRUMENTATIONInstallation = "ITR-5.7.0.2";
        public const string INSTRUMENTATIONCalibration = "ITR-5.7.3.1";
        public const string PIPEPressureTestRecord = "ITR-5-1";
        public const string PipeCleaningTravel = "ITR-5-17";
        public const string BoltTorquing = "ITR-5-18";
        public const string PIPAnsa = "ITR-5-16";
    }
    ...
    public sealed class UcTitle
    {
        ...
        public const string INSTRUMENTATIONReceiving = "Instrument Receiving Report";
        public const string INSTRUMENTATIONInstallation = "Instrument Installation Inspection";
        public const string INSTRUMENTATIONCalibration = "Instrument Calibration Record";
        public const string PIPEPressureTestRecord = "Pipe Pressure Test Record";
        public const string PipeCleaningTravel = "Pipe Cleaning Travel heet";
        public const string BoltTorquing = "Bolt Torquing Tensioning Travel";
        public const string PIPAnsa = "ABSA Report";
    }

    public sealed class TURNOVERSYSTEM
    {
        public const int MCQaqcformtype = 139;
        public const int TCCCQaqcformtype = 140;
        public const int QAQCDataTypeLuid = 1904;
    }
    ...
    public sealed class LOOKUPTYPE
    {
        ...
        public const string HydrostaticTest = "HydrostaticTest";
        ...
        public const string PneumaticTest = "PneumaticTest";
        ...
        public const string SDType = "SD";//Lookup:LookupType = 'ComponentTaskType'andlookupSubType = 'SD'(SDType(X))
        public const string Shape = "Shapes";//"Shape";
    ...
    public sealed class DocType
    {
        ...
        public const string ModelView = "741";
        public const string SafteyDoc = "742";
        ...
        public const string PSSR = "1984";
        public const string AssociatedDoc = "1985";
    }
    ...
    {
        public const int Scope = 1758;
        public const int FieldEquipment = 1759;
        public const int ConsumableMaterial = 1760;
        public const int ITR = 1761;
        public const int SafetyDocument = 1762;
        public const int SiteImage = 1763;
    }

    public sealed class DocEstablishedForCSU
    {
        public const int PnIDDrawing = 1987;
        public const int PSSR = 1988;
        public const int AssociatedDoc = 1989;
    }
    ...
    {
        public const string FIWP = "PACKAGE_TYPE_IWP";
        public const string SIWP = "PACKAGE_TYPE_SIWP";
        public const string HydroTest = "PACKAGE_TYPE_HYDRO";
        public const string CSU = "PACKAGE_TYPE_CSU";
    }
    ...
    public sealed class TaskCategoryCode
    {

        public const string Grounding = "EL_GROUNDING";
        public const string Equipment = "EL_EQUIPMENT";
        public const string LightingREC = "EL_LIGHTINGREC";
        public const string Raceway = "EL_RACEWAY";
        public const string Instruments = "EL_INSTRUMENTS";
        public const string EHT = "EL_EHT";
        public const string Cable = "EL_CABLE";
    }
