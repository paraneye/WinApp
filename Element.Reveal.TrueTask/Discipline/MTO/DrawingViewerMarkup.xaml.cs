...
namespace Element.Reveal.TrueTask.Discipline.MTO
{
    ...
    {
        private int _projectid, category;
        ...
        private int _drawingmode = DataLibrary.Utilities.DrawingMode.Pen;
        public bool IsOpen
        {
            get { return _isopen; }
            set { _isopen = value; }
        ...
        {
            _drawingmode = DataLibrary.Utilities.DrawingMode.Rectangle;
            //   StartEditing();
        }

        private void btnEllipse_Click(object sender, RoutedEventArgs e)
        {
            _drawingmode = DataLibrary.Utilities.DrawingMode.Ellipse;
        }

        private void btnLine_Click(object sender, RoutedEventArgs e)
        {
            _drawingmode = DataLibrary.Utilities.DrawingMode.Pen;
            //    StartEditing();
        }
        ...
        private void cvDrawing_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
            ...
            switch (_drawingmode)
            {
                case DataLibrary.Utilities.DrawingMode.Pen:
                    ProcessPenDown(pt);
                    break;
                case DataLibrary.Utilities.DrawingMode.Rectangle:
                    ...
                    break;
                case DataLibrary.Utilities.DrawingMode.Ellipse:
            ...
            if (e.Pointer.PointerId == _penID || _Current != null || e.GetCurrentPoint(cvDraw).Properties.IsLeftButtonPressed == true)
            {
                ...
                switch (_drawingmode)
                {
                    ...
                    case DataLibrary.Utilities.DrawingMode.Ellipse:
                        ...
                        break;
                    case DataLibrary.Utilities.DrawingMode.Text:
                        break;
                }
            }
