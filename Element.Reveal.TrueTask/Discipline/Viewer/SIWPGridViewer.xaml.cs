...
namespace Element.Reveal.TrueTask.Discipline.Viewer
{
    ...
    public sealed partial class SIWPGridViewer : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        private async void LoadDocument()
        {
            try
            {
                var item = _siwpoption.SelectredSIWP as DataLibrary.ComboBoxDTO;
                if (item != null)
                {
                ...
                _documentdto = await _siwpsource.GetItrDocumentForFIWPByFIWPID(DataLibrary.Utilities.AssembleStep.ITR, item.DataID, _projectid, _disciplineCode);
                ...
                if (Login.LoginMode == WinAppLibrary.UI.LogMode.OnMode)
                {
                    ...
                    if (login)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            await _siwpsource.GetIwpDrawingOnMode(item.DataID, _projectid, _disciplineCode, Lib.MainMenuList.SIWPViewer);
