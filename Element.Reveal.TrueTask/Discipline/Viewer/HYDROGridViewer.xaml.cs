...
namespace Element.Reveal.TrueTask.Discipline.Viewer
{
    ...
    public sealed partial class HYDROGridViewer : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        private async void LoadDocument()
        {
            try
            {
                var item = _hydrooption.SelectredHYDRO as DataLibrary.ComboBoxDTO;
                if (item != null)
                {
                ...
                _documentdto = await _hydrosource.GetItrDocumentForFIWPByFIWPID(DataLibrary.Utilities.AssembleStep.ITR, item.DataID, _projectid, _disciplineCode);
                ...
                if (Login.LoginMode == WinAppLibrary.UI.LogMode.OnMode)
                {
                    ...
                    if (login)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            await _hydrosource.GetIwpDrawingOnMode(item.DataID, _projectid, _disciplineCode, Lib.MainMenuList.HydroViewer);
