    ...
    public sealed partial class SelectTask : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        private async void LoadTask()
        {
            ...
            try
            {
                ...
                {
                    _materialcategory = await (new Lib.ServiceModel.CommonModel()).GetMaterialCategoryByModuleID(_disciplineCode);
        ...
        {
            Lib.CommonDataSource.selectedMaterialCategory = ((DataLibrary.MaterialcategoryDTO)lvTask.SelectedItem).MaterialCategoryID;
