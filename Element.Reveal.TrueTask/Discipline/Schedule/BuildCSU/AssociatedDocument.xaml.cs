...
namespace Element.Reveal.TrueTask.Discipline.Schedule.BuildCSU
{
    ...
    public sealed partial class AssociatedDocument : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            _doctype = DataLibrary.Utilities.SPCollectionName.AssociatedDoc;
        ...
        {
            Lib.WizardDataSource.SetTargetMenuForCSU(DataLibrary.Utilities.DocEstablishedForCSU.AssociatedDoc);
