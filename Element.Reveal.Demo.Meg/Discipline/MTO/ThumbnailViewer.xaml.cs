    ...
    public sealed partial class ThumbnailViewer : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        private async void LoadThumbnail() 
        {
            try 
            {
                ...
                thumbnailviewr = await (new Lib.ServiceModel.CommonModel()).GetDrawingByCWP(Lib.CWPDataSource.selectedCWP, Lib.CommonDataSource.selectedMaterialCategory, "", _projectid, _moduleid);
        ...
        {
            Lib.CommonDataSource.selectedDrawing = ((RevealCommonSvc.ComboBoxDTO)e.ClickedItem).DataID;
