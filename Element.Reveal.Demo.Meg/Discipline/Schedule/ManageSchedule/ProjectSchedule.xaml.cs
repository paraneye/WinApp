...
namespace Element.Reveal.Meg.Discipline.Schedule.ManageSchedule
{
    ...
    public sealed partial class ProjectSchedule : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        private void LoadProjectSchedule()
        {
            ...
            //Uri source = new Uri("http://reveal.elementindustrial.com/reveal.demo/Discipline/MobileReport.aspx?pageno=3&pjid=" + _projectid + "&mdid=" + _moduleid + "&cwid=" + Lib.CWPDataSource.selectedCWP + "&dbname=" + WinAppLibrary.Utilities.Helper.DBInstance);
            //Uri source = new Uri("http://dev.elementindustrial.com/Reveal.PreDemo/Discipline/MobileReport.aspx?pageno=3&pjid=" + _projectid + "&mdid=" + _moduleid + "&cwid=" + Lib.CWPDataSource.selectedCWP + "&dbname=" + WinAppLibrary.Utilities.Helper.DBInstance);
