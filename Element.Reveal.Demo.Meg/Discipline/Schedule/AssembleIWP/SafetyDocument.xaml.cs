...
namespace Element.Reveal.Meg.Discipline.Schedule.AssembleIWP
{
    ...
    /// </summary>
    public sealed partial class SafetyDocument : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            if (Lib.CommonDataSource.selPackageTypeLUID == Lib.PackageType.FIWP)
            {
                ...
                _doctype = SPCollectionName.SafetyDoc;
            }
            ...
            else
            {
                ...
                _doctype = SPCollectionName.HydroSafetyDoc;
            }
        ...
        {
            Lib.WizardDataSource.SetTargetMenu(WinAppLibrary.Utilities.DocEstablishedForApp.SafetyDocument, Lib.CommonDataSource.selPackageTypeLUID, true);
        ...
        private async void btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                foreach (RevealProjectSvc.DocumentDTO _dto in _trgSafety)
                {
                    ...
                    _dto.DocumentTypeLUID = Lib.DocType.SafteyDoc;
                    _dto.FIWPID = _fiwpid;
                ...
                if (Lib.CommonDataSource.selPackageTypeLUID == Lib.PackageType.FIWP)
                {
                    if (!fiwpdto[0].DocEstablishedLUID.Equals(WinAppLibrary.Utilities.DocEstablishedForApp.SiteImage))
                        fiwpdto[0].DocEstablishedLUID = WinAppLibrary.Utilities.DocEstablishedForApp.SafetyDocument;
                }
                else if (Lib.CommonDataSource.selPackageTypeLUID == Lib.PackageType.SIWP)
                {
                ...
                _trgSafety = await (new Lib.ServiceModel.ProjectModel()).GetDocumentForFIWPByDocType(Lib.DocType.SafteyDoc, _fiwpid, _projectid, _moduleid);
                ...
                if (Lib.CommonDataSource.selPackageTypeLUID == Lib.PackageType.HydroTest)
                {
                    ...
                    Lib.IWPDataSource.isWizard = iwpdto.DocEstablishedLUID == WinAppLibrary.Utilities.DocEstablishedForApp.SafetyDocument ? false : true;
