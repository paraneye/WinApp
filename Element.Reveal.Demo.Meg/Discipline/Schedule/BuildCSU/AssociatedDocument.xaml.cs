...
namespace Element.Reveal.Meg.Discipline.Schedule.BuildCSU
{
    ...
    /// </summary>
    public sealed partial class AssociatedDocument : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            _doctype = SPCollectionName.AssociatedDoc;
        ...
        {
            Lib.WizardDataSource.SetTargetMenuForCSU(WinAppLibrary.Utilities.DocEstablishedForCSU.AssociatedDoc);
        ...
        private async void btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
               ...
               // document.ProjectScheduleID = Lib.ScheduleDataSource.selectedSchedule;
                ...
                //fiwpdto[0].DocEstablishedLUID = WinAppLibrary.Utilities.DocEstablishedForCSU.AssociatedDoc;
               
                //_result = await (new Lib.ServiceModel.ProjectModel()).SaveSafetyDocumentForAssembleIWP(_savedto, fiwpdto, listdocument);
                _result = await (new Lib.ServiceModel.ProjectModel()).SaveAssociatedDocumentForBuildCSU(_savedto, fiwpdto, WinAppLibrary.Utilities.DocEstablishedForCSU.AssociatedDoc);
                _trgSafety = await (new Lib.ServiceModel.ProjectModel()).GetDocumentForFIWPByDocType(Lib.DocType.AssociatedDoc, _fiwpid, _projectid, _moduleid);
                ...
                iwpdto = Lib.IWPDataSource.csulist.Where(x => x.FiwpID == _fiwpid).FirstOrDefault();

                Lib.IWPDataSource.selectedHydro = iwpdto.FiwpID;
                Lib.IWPDataSource.selectedHydroName = iwpdto.FiwpName;
                Lib.IWPDataSource.isWizard = iwpdto.DocEstablishedLUID == WinAppLibrary.Utilities.DocEstablishedForCSU.AssociatedDoc? false : true;
        ...
        private async void LoadTemplate()
        {
            ...
            {
                (new WinAppLibrary.Utilities.Helper()).ExceptionHandler(e, "Load Associated Document", "There was an error load Data. Pleae contact administrator", "Error!");
            }
