...
namespace Element.Reveal.Meg.Discipline.TurnOver
{
    ...
    /// </summary>
    public sealed partial class TCCCCertificate : UserControl
    {
        ...
        private async void LoadData()
        {
            try
            {
                ...
                _dtoform = await (new Lib.ServiceModel.ProjectModel()).GetTurnoverCertificateForTCCC(_projectid, systemId);
                if (_dtoform != null)
                {

                    //txtSir.Text = !string.IsNullOrEmpty(_qaqcdto[0].KeyValue) ? _qaqcdto[0].KeyValue : "";
                    //txtContens.Text = !string.IsNullOrEmpty(_qaqcdto[0].Comments) ? _qaqcdto[0].Comments : "";
        ...
        private async void SaveData()
        {
            ...
            try
            {
                ...
                await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
                {
                    ...
                    _dtoform.QAQCFormTemplateID = Lib.TURNOVERSYSTEM.TCCCQaqcformtype;
                ...
                result = await project.SaveTurnoverCertificateForTCCC(document, _dtoform, systemId);
        ...
        private async void btnPrint_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                document.UpdatedDate = DateTime.Now;
                document.ProjectID = _projectid;
                _documentlist = await project.SaveTurnoverCertificatePDFForTCCC(document, _dtoform, systemId);
        ...
        private void Clear(ListView lv)
        {
            signed = new List<WinAppLibrary.UI.ObjectNFCSign>{
                new WinAppLibrary.UI.ObjectNFCSign{
                isSigned = "UnSigned",
