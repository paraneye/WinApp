...
namespace Element.Reveal.Meg.Discipline.ITR
{
    ...
    public sealed partial class SelectFiwpITR : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        public SelectFiwpITR()
        {
            ...
            Login.MasterPage.ShowBackButton();
        ...
        private async void BindFiwpList()
        {
            try
            {
                ...
                await _FiwpList.GetFiwpList(Login.UserAccount.CurProjectID, Login.UserAccount.CurModuleID, Login.UserAccount.PersonnelID, 0); //Department.Foreman);
