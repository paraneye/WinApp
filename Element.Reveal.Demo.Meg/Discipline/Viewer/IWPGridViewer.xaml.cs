    ...
    public sealed partial class IWPGridViewer : WinAppLibrary.Controls.LayoutAwarePage
    {
        ...
        private async void LoadDocument()
        {
            try
            {
                ...
                _documentdto = await _iwpsource.GetItrDocumentForFIWPByFIWPID(WinAppLibrary.Utilities.DocEstablishedForApp.ITR, item.DataID, _projectid, _moduleid);
                ...
                if (Login.LoginMode == WinAppLibrary.UI.LogMode.OnMode)
                {
                    ...
                    if (login)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            await _iwpsource.GetIwpDrawingOnMode(item.DataID, _projectid, _moduleid, Lib.MainMenuList.IWPViewer);
